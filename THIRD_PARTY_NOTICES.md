...
ELK and resvg remain separate third-party components under their upstream terms. There are no proprietary runtime dependencies or required operated services. This table covers principal direct dependencies, not every transitive package; use installed package licenses and the lockfile for a complete redistribution inventory.
